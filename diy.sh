...
##############################作者昵称（必填）############################## 
# 使用空格隔开 
author_list="qq34347476 i-chenzhe moposmall yangtingxiao luyiwind" 
##############################作者脚本地址URL（必填）############################## 
...
scripts_base_url_5=https://raw.githubusercontent.com/luyiwind/JD_config/js/
##############################作者脚本名称（必填）############################## 
# 将相应作者的脚本填写到以下变量中 
...
my_scripts_list_5="jd_live_redrain.js"
