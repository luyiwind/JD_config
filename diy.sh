...
cd $ConfigDir
echo -e "开始更新 diy.sh "
wget -q --no-check-certificate https://gitee.com/qq34347476/quantumult-x/raw/master/diy.sh -O diy.sh.new
if [ $? -eq 0 ]; then
...
wget -q --no-check-certificate https://gitee.com/qq34347476/quantumult-x/raw/master/manual-update.sh -O manual-update.sh.new
if [ $? -eq 0 ]; then
